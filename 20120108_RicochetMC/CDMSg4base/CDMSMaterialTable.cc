// $Id: CDMSMaterialTable.cc,v 1.2 2011/07/28 05:58:49 kelsey Exp $
////////////////////////////////////////////////////////////////////////
//                                                                    //
...
const CDMSMaterialTable CDMSMaterialTable::Instance;


// Constructor -- make sure you add new materials here!

CDMSMaterialTable::CDMSMaterialTable() {
  ...
  // Create CDMS-specific materials
  CreateGreenstone();
  CreateNorite();
  CreateMuMetal();
  CreateScintillator();
...
//    Background CDMS ebook note (2007)
void CDMSMaterialTable::CreateGreenstone() {
...
void CDMSMaterialTable::CreateNorite() {
  G4NistManager* nist = G4NistManager::Instance();
...
void CDMSMaterialTable::CreateMuMetal() {
  G4NistManager* nist = G4NistManager::Instance();
...
void CDMSMaterialTable::CreateScintillator() {
  G4NistManager* nist = G4NistManager::Instance();
...
G4Material* CDMSMaterialTable::GetMaterial(const G4String& mat) {
