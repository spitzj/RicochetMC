// $Id: CDMSTowerSupportConstruction.cc,v 1.12 2011/07/22 21:09:17 kelsey Exp $
////////////////////////////////////////////////////////////////////////
//                                                                    //
//  File:        CDMSTowerSupportConstruction.hh                      //
//                                                                    //
...
//                                                                    //
//  20101208  M. Kelsey -- Extracted from CDMSVesselConstruction      //
//  20101209  M. Kelsey -- Fix a variety of volume placement errors   //
...
//  20101216  M. Kelsey -- Use negative indices to count from outside //
//  20110215  M. Kelsey -- Report mass at end of construction.        //
//  20110326  M. Kelsey -- Use Manager to access tower.               //
...
#include "CDMSgeometry/interface/CDMSTowerSupportMessenger.hh"
...
CDMSTowerSupportConstruction::CDMSTowerSupportConstruction()
  : CDMSVDetectorGeometry("TowerSupport"), towerBuilder(0), NStages(6),
    ...
    messenger(new CDMSTowerSupportMessenger(this)) {}


void CDMSTowerSupportConstruction::FillExtraParameters() {
  if (verboseLevel>1) 
    G4cout << "CDMSTowerSupportConstruction::FillExtraParameters()" << G4endl;
...
void CDMSTowerSupportConstruction::CopyTowerParameters() {
  if (verboseLevel>1) 
    G4cout << "CDMSTowerSupportConstruction::CopyTowerParameters()" << G4endl;

  if (!towerBuilder) {
    towerBuilder = CDMSGeometryManager::Instance()->GetTower();
...
void CDMSTowerSupportConstruction::FillSupportParameters() {
  if (verboseLevel>1) 
    G4cout << "CDMSTowerSupportConstruction::FillSupportParameters()" << G4endl;
...
void CDMSTowerSupportConstruction::FillReadoutParameters() {
  if (verboseLevel>1) 
    G4cout << "CDMSTowerSupportConstruction::FillReadoutParameters()" << G4endl;
...
G4LogicalVolume* CDMSTowerSupportConstruction::BuildGeometry() {
  if (verboseLevel)
    G4cout << "CDMSTowerSupportConstruction::BuildGeometry()" << G4endl;
...
void 
CDMSTowerSupportConstruction::AttachCopperSpool(G4LogicalVolume* theSupport) {
  if (verboseLevel>1)
    G4cout << "CDMSTowerSupportConstruction::AttachCopperSpool()" << G4endl;
...
void 
CDMSTowerSupportConstruction::AttachSupportTube(G4LogicalVolume* theSupport) {
  if (verboseLevel>1)
    G4cout << "CDMSTowerSupportConstruction::AttachSupportTube()" << G4endl;
...
void
CDMSTowerSupportConstruction::AttachSupportStage(G4int stage, 
						  G4LogicalVolume* theSupport) {
  if (verboseLevel>1)
    G4cout << "CDMSTowerSupportConstruction::AttachSupportStage " << stage << G4endl;
...
void
CDMSTowerSupportConstruction::AttachReadout(G4int side, 
					     G4LogicalVolume* theSupport) {
  if (verboseLevel>1)
    G4cout << "CDMSTowerSupportConstruction::AttachReadout " << side << G4endl;
...
G4LogicalVolume* CDMSTowerSupportConstruction::BuildSquidCard() {
  if (verboseLevel>1)
    G4cout << "CDMSTowerSupportConstruction::BuildSquidCard()" << G4endl;
...
G4LogicalVolume* CDMSTowerSupportConstruction::BuildFETCard() {
  if (verboseLevel>1)
    G4cout << "CDMSTowerSupportConstruction::BuildFETCard()" << G4endl;
...
G4LogicalVolume* 
CDMSTowerSupportConstruction::BuildSideStrip(G4double stripLen) {
  if (verboseLevel>1) {
    G4cout << "CDMSTowerSupportConstruction::BuildSideStrip " << stripLen << " mm"
	   << G4endl;
  }
...
void CDMSTowerSupportConstruction::PrintParameters(std::ostream& os) const {
  os << "CDMSTowerSupportConstruction parameters\n NStages " << NStages
