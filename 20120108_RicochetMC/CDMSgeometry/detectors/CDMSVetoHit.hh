// $Id: CDMSVetoHit.hh,v 1.5 2011/05/04 20:17:22 kelsey Exp $
////////////////////////////////////////////////////////////////////////
//                                                                    //
//  File:        CDMSVetoHit.hh                                       //
//  Description: hit definition class for veto scintillator,          //
//               modified from original CDMSmain version              //
//                                                                    //
...
#ifndef CDMSVetoHit_h
#define CDMSVetoHit_h 1
...
class CDMSVetoHit : public G4VHit {
public:
  CDMSVetoHit();
  CDMSVetoHit(const CDMSVetoHit&);
  
  ~CDMSVetoHit();
  
  const CDMSVetoHit& operator=(const CDMSVetoHit&);
  int operator == (const CDMSVetoHit&) const;
...
typedef G4THitsCollection<CDMSVetoHit> CDMSVetoHitsCollection;
extern G4Allocator<CDMSVetoHit> CDMS_VetoHitAllocator;

inline void* CDMSVetoHit::operator new(size_t) {
  void* aHit;
  aHit = (void*) CDMS_VetoHitAllocator.MallocSingle();
  return aHit;
}

inline void CDMSVetoHit::operator delete(void* aHit) {
  CDMS_VetoHitAllocator.FreeSingle((CDMSVetoHit*) aHit);
}
