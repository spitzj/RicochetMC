// $Id: CDMSVetoSD.cc,v 1.4 2011/05/04 20:17:22 kelsey Exp $
////////////////////////////////////////////////////////////////////////
//                                                                    //
//  File:        CDMSVetoSD.cc                                        //
...
//                                                                    //
//  20110427  M. Kelsey -- Save coordinate transformation for panel   //
//  20110504  M. Kelsey -- Fix constness of ctor string.              //
////////////////////////////////////////////////////////////////////////

#include "CDMSgeometry/detectors/CDMSVetoSD.hh"
...
CDMSVetoSD::CDMSVetoSD(const G4String& SDname)
...
CDMSVetoSD::~CDMSVetoSD() {}

void CDMSVetoSD::Initialize(G4HCofThisEvent* HCE)
{
  vetoHitsCollection =
    new CDMSVetoHitsCollection(SensitiveDetectorName,collectionName[0]);
  G4int HCID = -1;
...
G4bool CDMSVetoSD::ProcessHits(G4Step* aStep, G4TouchableHistory* /*ROhist*/)
{
  ...
  CDMSVetoHit* vetoHit = new CDMSVetoHit();
...
void CDMSVetoSD::EndOfEvent(G4HCofThisEvent* /*HCE*/)
{
  if (verboseLevel>0) {
