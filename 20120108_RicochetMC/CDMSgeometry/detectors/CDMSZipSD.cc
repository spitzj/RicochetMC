// $Id: CDMSZipSD.cc,v 1.10 2011/07/11 16:52:27 rudy Exp $
////////////////////////////////////////////////////////////////////////
//                                                                    //
//  File:        CDMSZipSD.cc                                         //
//  Description: sensitive detector class for CDMSMini                //
//                                                                    //
//  Author:      Dennis Wright (SLAC)                                 //
//  Date:        15 July 2010                                         //
//                                                                    //
//  20110121  M. Kelsey -- Eliminate diagnostic statement.            //
//  20110427  M. Kelsey -- Save coordinate transformation for ZIP     //
//  20110504  M. Kelsey -- Fix constness of ctor string, discard hits //
//		with post-step outside of detector.                   //
//  20110630  M. Kelsey -- Drop post-step volume checking (redundant) //
////////////////////////////////////////////////////////////////////////
...
CDMSZipSD::CDMSZipSD(const G4String& SDname)
...
void CDMSZipSD::Initialize(G4HCofThisEvent* HCE)
{
...
G4bool CDMSZipSD::ProcessHits(G4Step* aStep, G4TouchableHistory* /*ROhist*/)
{
...
void CDMSZipSD::EndOfEvent(G4HCofThisEvent* /*HCE*/)
{
  if (verboseLevel>0) {
