// $Id: CDMSTowerSupportMessenger.cc,v 1.6 2010/12/28 05:13:42 kelsey Exp $
////////////////////////////////////////////////////////////////////////
//                                                                    //
//  File:        CDMSTowerSupportMessenger.cc                         //
//                                                                    //
...
CDMSTowerSupportMessenger::CDMSTowerSupportMessenger(CDMSTowerSupportConstruction* builder)
  : theBuilder(builder) {
  cmdDir = new G4UIdirectory("/CDMS/Support/");
  cmdDir->SetGuidance("Define dimensions and parameters for CDMS tower support");

  NStagesCmd = new G4UIcmdWithAnInteger("/CDMS/Support/Stages", this);
  ...
  StageHeightCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/StageHeight", this);
  ...
  StageWallThickCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/StageWallThick", this);
  ...
  StageGapCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/StageGap", this);
  ...
  VesselMountStageCmd = new G4UIcmdWithAnInteger("/CDMS/Support/VesselMountStage", this);
  ...
  SpoolLengthCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/SpoolLength", this);
  ...
  SpoolIRCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/SpoolIR", this);
  ...
  SpoolThicknessCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/SpoolThickness", this);
  ...
  CTubeIRCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/CTubeIR", this);
  ...
  CTubeThickCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/CTubeThick", this);
  ...
  SquidLenCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/SquidLen", this);
  ...
  SquidThickCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/SquidThick", this);
  ...
  SquidStageCmd = new G4UIcmdWithAnInteger("/CDMS/Support/SquidStage", this);
  ...
  FETLenCmd = new G4UIcmdWithADoubleAndUnit("/CDMS/Support/FETLen", this);
  ...
  FETStageCmd = new G4UIcmdWithAnInteger("/CDMS/Support/FETStage", this);
...
CDMSTowerSupportMessenger::~CDMSTowerSupportMessenger() {
  delete NStagesCmd;
...
void CDMSTowerSupportMessenger::SetNewValue(G4UIcommand* cmd, G4String value) {
  if (cmd == NStagesCmd)
